...
# python ./yolov5/val.py --img $IMG_SIZE --data $YAML_FOLD_1 --weights $PROJECT/yolov5l-fold_1/weights/best.pt --device $DEVICE --batch-size $BATCH_SIZE --project $PROJECT --name yolov5l-fold_1
# python ./yolov5/val.py --img $IMG_SIZE --data $YAML_FOLD_2 --weights $PROJECT/yolov5l-fold_2/weights/best.pt --device $DEVICE --batch-size $BATCH_SIZE --project $PROJECT --name yolov5l-fold_2
# python ./yolov5/val.py --img $IMG_SIZE --data $YAML_FOLD_3 --weights $PROJECT/yolov5l-fold_3/weights/best.pt --device $DEVICE --batch-size $BATCH_SIZE --project $PROJECT --name yolov5l-fold_3

# python ./yolov5/val.py --img $IMG_SIZE --data $YAML_FOLD_1 --weights $PROJECT/yolov5x-fold_1/weights/best.pt --device $DEVICE --batch-size $BATCH_SIZE --project $PROJECT --name yolov5x-fold_1
# python ./yolov5/val.py --img $IMG_SIZE --data $YAML_FOLD_2 --weights $PROJECT/yolov5x-fold_2/weights/best.pt --device $DEVICE --batch-size $BATCH_SIZE --project $PROJECT --name yolov5x-fold_2
# python ./yolov5/val.py --img $IMG_SIZE --data $YAML_FOLD_3 --weights $PROJECT/yolov5x-fold_3/weights/best.pt --device $DEVICE --batch-size $BATCH_SIZE --project $PROJECT --name yolov5x-fold_3
